...
@Component({
  selector: 'app-four-instruction',
  templateUrl: './four-instruction.component.html',
  styleUrl: './four-instruction.component.css'
})
export class FourInstructionComponent  implements OnInit {
