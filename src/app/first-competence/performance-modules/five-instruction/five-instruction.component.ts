...
@Component({
  selector: 'app-five-instruction',
  templateUrl: './five-instruction.component.html',
  styleUrl: './five-instruction.component.css'
})
export class FiveInstructionComponent implements OnInit {
  ...
  nextCard() {
    if (this.currentCard < 10) { // Se ajusta al nuevo número de tarjetas
      this.currentCard += 1;
    }
  }
